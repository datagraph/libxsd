...
TEST_CASE("without_tz") {
  REQUIRE(xsd::date::parse("1970-01-01") == 0);                  /* epoch          */
  REQUIRE(xsd::date::parse("2038-01-19") == 2147472000000000);   /* circa (2^31)-1 */
#ifndef __APPLE__
  REQUIRE(xsd::date::parse("1901-12-13") == -2147558400000000);  /* circa -(2^31)  */
#endif
}
