...
TEST_CASE("without_tz") {
  REQUIRE(xsd::datetime::parse("1970-01-01T00:00:00") == 0);                  /* epoch    */
  REQUIRE(xsd::datetime::parse("2038-01-19T03:14:07") == 2147483647000000);   /* (2^31)-1 */
  REQUIRE(xsd::datetime::parse("1901-12-13T20:45:52") == -2147483648000000);  /* -(2^31)  */
}
