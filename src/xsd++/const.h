...
#define XSD_DECIMAL_PATTERN     "^([-+])?(?|0*([0-9]+?)(?:\\.([0-9]*?)0*)?|0*([0-9]*?)\\.([0-9]+?)0*)$" // 1+(2|") groups -> 4 captures
#define XSD_INTEGER_PATTERN     "^([-+])?0*([0-9]+)$" // 2 groups -> 3 captures
//#define XSD_FLOAT_PATTERN     "^([-+])?0*([0-9]*)\\.?(0*[0-9]*)0*[Ee]?([-+])?0*([0-9]*)?$" // 5  groups -> 6 captures
#define XSD_FLOAT_PATTERN       "^([-+])?(?|0*([0-9]+?)(?:\\.([0-9]*?)0*)?|0*([0-9]*?)\\.([0-9]+?)0*)(?:[Ee]([-+])?0*([0-9]+?)0*)?$" // 1+(2|2)+2 groups -> 6 captures
